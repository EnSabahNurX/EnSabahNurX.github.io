...
const menu = [
    ...
    },
    {
        ...
        desc: `steak is quite expensive but always worth each grama, skateboard fam synth authentic semiotics. Live-edge lyft af, edison bulb yuccie crucifix microdosing.`,
    }
];
...
function displayMenuButtons() {
    const categories = menu.reduce((values, item) =>
        ((!values.includes(item.category)) ? values.push(item.category) : '', values), ['all'])
